import { GoodsReceipt, StockLedgerEntry, StockLot } from '@core/models';
...
export const GOODS_RECEIPTS: GoodsReceipt[] = [
  ...
  },
  {
    ...
    lines: [
      { itemId: 'MP00001', expectedQuantity: 40, receivedQuantity: 40, acceptedQuantity: 40, claimedQuantity: 0, locationId: 'LOC-ALM-A', inspectionResult: 'compliant' },
      { itemId: 'MP00002', expectedQuantity: 40, receivedQuantity: 40, acceptedQuantity: 40, claimedQuantity: 0, locationId: 'LOC-ALM-A', inspectionResult: 'compliant' },
    ],
  ...
  },
  {
    ...
    lines: [
      { itemId: 'MA00001', expectedQuantity: 60, receivedQuantity: 60, acceptedQuantity: 60, claimedQuantity: 0, locationId: 'LOC-CALDERO', inspectionResult: 'compliant' },
      { itemId: 'MA00024', expectedQuantity: 40, receivedQuantity: 40, acceptedQuantity: 40, claimedQuantity: 0, locationId: 'LOC-CALDERO', inspectionResult: 'compliant' },
    ],
  ...
  },
  {
    ...
    receivedBy: 'Cristian Espinoza',
    lines: [{ itemId: 'SU01122', expectedQuantity: 80, receivedQuantity: 80, acceptedQuantity: 72, claimedQuantity: 8, locationId: 'LOC-RECL', inspectionResult: 'observed', note: '8 unidades con rosca dañada — enviadas a reclamo, no incrementan stock disponible.' }],
  ...
  },
  {
    ...
    lines: [{ itemId: 'MP00011', expectedQuantity: 3000, receivedQuantity: 0, acceptedQuantity: 0, claimedQuantity: 0, locationId: 'LOC-REC', inspectionResult: 'compliant' }],
    photos: [],
  },
  {
    ...
    lines: [{ itemId: 'MA00031', expectedQuantity: 200, receivedQuantity: 0, acceptedQuantity: 0, claimedQuantity: 0, locationId: 'LOC-REC', inspectionResult: 'compliant' }],
    photos: [],
  },
];
...
export const STOCK_LEDGER: StockLedgerEntry[] = [
  ...
  { id: 'SL-009', date: '2026-07-14', itemId: 'MA00054', type: 'outbound', documentNumber: 'SAL-SUM-000052', documentType: 'OutputBundle', warehouseId: 'WH-001', locationId: 'LOC-CALDERO', inboundQuantity: 0, outboundQuantity: 5, balance: 34, unitCost: 12.3, user: 'Haldeer Vasquez' },
  { id: 'SL-010', date: '2026-07-15', itemId: 'SU00130', type: 'outbound', documentNumber: 'SAL-SUM-000061', documentType: 'OutputBundle', warehouseId: 'WH-001', locationId: 'LOC-CALDERO', inboundQuantity: 0, outboundQuantity: 7, balance: 68, unitCost: 1.25, user: 'Haldeer Vasquez' },
  { id: 'SL-011', date: '2026-07-16', itemId: 'SU01122', type: 'inbound', documentNumber: 'REC-2026-0290', documentType: 'GoodsReceipt', warehouseId: 'WH-001', locationId: 'LOC-ALM-B', inboundQuantity: 72, outboundQuantity: 0, balance: 72, unitCost: 19, user: 'Cristian Espinoza' },
  { id: 'SL-012', date: '2026-07-16', itemId: 'SU01122', type: 'adjustment', documentNumber: 'REC-2026-0290-CLAIM', documentType: 'Adjustment', warehouseId: 'WH-001', locationId: 'LOC-RECL', inboundQuantity: 0, outboundQuantity: 0, balance: 8, unitCost: 19, user: 'Rosa Injante' },
  { id: 'SL-013', date: '2026-07-21', itemId: 'MA00001', type: 'inbound', documentNumber: 'REC-2026-0285', documentType: 'GoodsReceipt', warehouseId: 'WH-001', locationId: 'LOC-CALDERO', inboundQuantity: 60, outboundQuantity: 0, balance: 60, unitCost: 12.8, user: 'Haldeer Vasquez' },
  { id: 'SL-014', date: '2026-07-26', itemId: 'MA00024', type: 'inbound', documentNumber: 'REC-2026-0285', documentType: 'GoodsReceipt', warehouseId: 'WH-001', locationId: 'LOC-CALDERO', inboundQuantity: 40, outboundQuantity: 0, balance: 40, unitCost: 12.1, user: 'Haldeer Vasquez' },
...
export const STOCK_LOTS: StockLot[] = [
  ...
  { id: 'LOT-007', itemId: 'SU01122', lot: 'ACC-20260716', receivedAt: '2026-07-16', locationId: 'LOC-ALM-B', quantity: 72, status: 'available', unitCost: 19, sourceDocument: 'REC-2026-0290' },
  { id: 'LOT-008', itemId: 'SU01122', lot: 'ACC-20260716-RECLAMO', receivedAt: '2026-07-16', locationId: 'LOC-RECL', quantity: 8, status: 'claimed', unitCost: 19, sourceDocument: 'REC-2026-0290' },
  { id: 'LOT-009', itemId: 'MP00046', lot: 'POSTE-20260807-P1', receivedAt: '2026-08-07', locationId: 'LOC-ALM-C', quantity: 24, status: 'available', unitCost: 287, sourceDocument: 'HT-2026-0298' },
  { id: 'LOT-010', itemId: 'MP00046', lot: 'POSTE-20260731-P1', receivedAt: '2026-07-31', locationId: 'LOC-ALM-C', quantity: 18, status: 'reserved', unitCost: 287, sourceDocument: 'HT-2026-0291' },
  { id: 'LOT-011', itemId: 'MP00047', lot: 'DUCTO4V-20260805-P3', receivedAt: '2026-08-05', locationId: 'LOC-ALM-C', quantity: 40, status: 'available', unitCost: 170, sourceDocument: 'HT-2026-0300' },
  { id: 'LOT-012', itemId: 'MP00049', lot: 'CAJA-20260806-ACC', receivedAt: '2026-08-06', locationId: 'LOC-ALM-C', quantity: 32, status: 'available', unitCost: 96.5, sourceDocument: 'HT-2026-0305' },
  { id: 'LOT-013', itemId: 'MA00001', lot: 'ELEC-20260721', receivedAt: '2026-07-21', locationId: 'LOC-CALDERO', quantity: 34, status: 'available', unitCost: 12.8, sourceDocument: 'REC-2026-0285' },
  { id: 'LOT-014', itemId: 'MP00006', lot: 'CEM-20260615-VIEJO', receivedAt: '2026-06-15', locationId: 'LOC-CUAR', quantity: 20, status: 'quarantine', unitCost: 21.5, sourceDocument: 'REC-2026-0250' },
];
