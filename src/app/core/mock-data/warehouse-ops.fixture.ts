...
export const STOCK_LEDGER: StockLedgerEntry[] = [
  ...
  { id: 'SL-012', date: '2026-07-16', itemId: 'SU01122', type: 'outbound', documentNumber: 'REC-2026-0290-CLAIM', documentType: 'Adjustment', warehouseId: 'WH-001', locationId: 'LOC-P2', inboundQuantity: 0, outboundQuantity: 0, balance: 8, unitCost: 19, user: 'Rosa Injante' },
