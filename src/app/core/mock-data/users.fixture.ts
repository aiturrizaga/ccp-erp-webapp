...
export const APP_USERS: AppUser[] = [
  ...
  { id: 'USR-004', email: 'margot@ccp.pe', password: 'prueb@s', name: 'Margot', area: 'Finanzas', role: 'billing' },
  { id: 'USR-005', email: 'admin@ccp.pe', password: 'prueb@s', name: 'Admin', area: 'Todas las áreas', role: 'admin' },
];
