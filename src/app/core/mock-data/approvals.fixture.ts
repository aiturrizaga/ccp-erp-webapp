...
export const APPROVALS: Approval[] = [
  {
    id: 'APR-001', process: 'purchase_requisition', documentId: 'PR-006', documentNumber: 'SC-2026-0138',
    description: 'Electrodos de soldadura para mantenimiento de moldes', amount: 1252, currency: 'PEN', plant: 'Planta Lima',
  ...
  },
  {
    ...
    description: 'Cemento CEMEX Portland Tipo I — 600 bolsas', amount: 13200, currency: 'PEN', plant: 'Planta Lima',
  ...
  },
  {
    ...
    description: 'Importación de moldes para poste 9m (repuesto de rueda)', amount: 380, currency: 'USD', plant: 'Planta Lima',
  ...
  {
    id: 'APR-004', process: 'purchase_requisition', documentId: 'PR-007', documentNumber: 'SC-2026-0139',
    description: 'Repuesto de brida para molde de poste', amount: 1320, currency: 'PEN', plant: 'Planta Lima',
  ...
  {
    id: 'APR-005', process: 'purchase_requisition', documentId: 'PR-002', documentNumber: 'SC-2026-0143',
    description: 'Sellador y alquitrán para acabado de ductos', amount: 3105, currency: 'PEN', plant: 'Planta Lima',
  ...
  },
  {
    ...
    description: 'Fierro corrugado 1/2" — 2000 unidades', amount: 34000, currency: 'PEN', plant: 'Planta Lima',
  ...
  },
  {
    ...
    description: 'Alta de proveedor: AUTO PARTS PLUS I & A S.A.C.', plant: 'Planta Lima',
  ...
  },
  {
    ...
    description: 'Alta de proveedor: AHORA QUISCA INVERSIONES SAC-AQUISI S.A.C.', plant: 'Planta Lima',
  ...
  },
  {
    ...
    description: 'Tubería PVC 5/8" — 200 unidades', amount: 740, currency: 'PEN', plant: 'Planta Lima',
  ...
  },
  {
    ...
    description: 'Cambio de receta: Caja cuadrada 40x40x30 — reducción de cemento por optimización de mezcla', plant: 'Planta Lima',
