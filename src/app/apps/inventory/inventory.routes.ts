...
export const INVENTORY_ROUTES: Routes = [
  ...
  { path: 'work-sheets-board', loadComponent: () => import('./work-sheets-board/work-sheets-board').then((m) => m.WorkSheetsBoard) },
  ...
  { path: 'stock-issues/dispatch', loadComponent: () => import('./stock-issues/stock-issue-dispatch/stock-issue-dispatch').then((m) => m.StockIssueDispatch) },
